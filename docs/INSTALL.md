...
**Optional apt source (same repo, GitHub Pages):** if maintainers enabled signing and Pages on branch **`gh-pages`**, you can add the published apt mirror and run `sudo apt install i2pchat` — see [`packaging/apt/README.md`](../packaging/apt/README.md).

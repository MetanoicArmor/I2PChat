...
<img src="../screenshots/2.png" alt="Меню «⋯»: профили, отправка, peer lock, история чата ON/OFF и очистка" width="320" />
...
- **Chat history: ON/OFF** — включить/выключить сохранение локальной истории (см. раздел 4.11).

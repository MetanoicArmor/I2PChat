...
- **Поле ввода** — под областью чата: введите текст. **Enter** делает новую строку, а отправка сообщения — **Shift+Enter** (а также **Ctrl+Enter**, и на macOS **⌘+Enter**). Или используйте кнопку отправки.

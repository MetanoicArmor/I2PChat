...
|----------|----------|--------|
| **Windows** | *(coming soon for v0.5.0)* | — |
| **macOS** | [I2PChat-macOS-arm64-v0.5.0.zip](https://github.com/MetanoicArmor/I2PChat/releases/latest/download/I2PChat-macOS-arm64-v0.5.0.zip) | Unzip → `I2PChat.app` |
| **Linux** | *(coming soon for v0.5.0)* | — |

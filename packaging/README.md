...
| **apt + GitHub Pages (это же репо)** | **Живое:** [metanoicarmor.github.io/I2PChat-ng](https://metanoicarmor.github.io/I2PChat-ng/) (`v1.4.0`, amd64+arm64, подписано). Старый URL **`…/I2PChat/`** после rename — **404**. Обновление: [`apt/README.md`](apt/README.md), workflow **Publish apt mirror** / **deploy-apt-site**. |

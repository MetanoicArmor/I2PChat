...
Готовые манифесты для [Windows Package Manager](https://learn.microsoft.com/windows/package-manager/) лежат в каталоге с версией, например [`1.2.1/`](1.2.1/).
...
2. Скопируйте три YAML-файла в ветку:
   ...
   `manifests/m/MetanoicArmor/I2PChat/1.2.1/`
...
```powershell
winget validate --manifest .\packaging\winget\1.2.1
```

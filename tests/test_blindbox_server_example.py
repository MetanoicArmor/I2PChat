...
class LocalServerExampleStringsTests(unittest.TestCase):
    ...
    def test_production_daemon_package_assets_are_available(self) -> None:
        ...
        curl_cmd = local_example.get_production_daemon_one_shot_install_curl_command()
        self.assertIn("raw.githubusercontent.com/MetanoicArmor/I2PChat/main/", curl_cmd)
        self.assertIn("sudo bash install.sh", curl_cmd)
